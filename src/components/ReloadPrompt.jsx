...
export function ReloadPrompt() {
  ...
  const [lastOfflineReady, setLastOfflineReady] = useState(false);
  const [lastNeedRefresh, setLastNeedRefresh] = useState(false);

  if (offlineReady && !lastOfflineReady) {
    setLastOfflineReady(true);
    toast({
